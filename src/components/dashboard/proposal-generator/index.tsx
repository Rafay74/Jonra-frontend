  ...
  return (
    <div className="h-full flex flex-col p-4 md:p-6 gap-4 md:gap-6">
      ...
      <div className="bg-[#C9C9C933] h-screen rounded-2xl p-8 flex flex-col gap-4 overflow-y-auto ">
        ...
        <div className="flex-1 bg-[#bcb7b733] rounded-3xl  p-6 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xl font-bold text-[#1EC5E0]">
              Information
            </span>
        ...
        <div className="flex-1 rounded-3xl bg-[#bcb7b733] p-6 space-y-4">
          <span className="text-xl font-bold text-[#1EC5E0]">Settings</span>
