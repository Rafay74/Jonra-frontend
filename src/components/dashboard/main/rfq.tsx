  ...
  return (
    <div className="w-full border-2 border-[#1EC5E066] rounded-4xl p-6 bg-[#123C4E] flex flex-col h-full">
      ...
      <div className="flex justify-between items-center mb-4">
        <span className="text-[#1EC5E0] text-2xl font-semibold">RFQs Table</span>
        <div className="flex gap-2 items-center">
          <Link to={''} className="text-white text-sm hover:text-[#1EC5E0] transition-colors">
            See All
          </Link>
      ...
      <div className="grid grid-cols-2 gap-4">
        {[1, 2].map((item) => (
          <div key={item} className={`bg-white rounded-2xl ${item > 2 ? 'opacity-40' : ''}`}>
            <div className="relative w-full h-20">
              {' '}
              <img src={rfq} alt="rfq" className="object-cover w-full h-full rounded-t-2xl" />
            ...
            <div className="p-2 space-y-2">
              <div className="text-[#092835] font-semibold text-lg">RFQ (DLA)</div>
