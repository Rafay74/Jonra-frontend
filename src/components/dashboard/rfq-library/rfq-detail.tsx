      ...
      <div className="bg-[#C9C9C933] rounded-2xl p-4 md:p-6 lg:p-8 flex flex-col gap-3 md:gap-4 overflow-y-auto">
        <div className="bg-[#C5F7FF] rounded-3xl p-3 md:p-4 flex flex-col gap-2">
          <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
            <span className="text-black font-bold text-sm md:text-md">
              Country:
            </span>
            <div className="flex items-center gap-2">
              <img
          ...
          <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-2">
            <span className="text-black font-bold text-sm md:text-md shrink-0">
              Summary:
            </span>
        ...
        <div className="bg-[#C5F7FF] rounded-3xl p-3 md:p-4 flex flex-col gap-2">
          ...
          <p className="text-black text-sm md:text-base lg:text-lg xl:text-xl leading-relaxed">
            ...
            amet est necessitatibus! Amet perferendis dicta, nisi minima non,
            maiores sed accusamus eum ex vel eaque ratione commodi impedit?
            Impedit, ise, hic quasi illo vero dolores debitis vel, provident eum
            itaque fuga eligendi. Laborum quam porro exercitationem fuga totam,
            in modi doloribus voluptatem architecto rerum temporibus recusandae,
            animi, doloremque necessitatibus reprehenderit expedita blanditiis.
            Eius veniam dolorem laborum eum explicabo ea accusantium modi
            dignissimos! Omnis velit optio nesciunt sunt vel quis illo ipsa odit
            consequuntur ipsam et impedit eligendi dolor nulla nihil aut soluta
            a nam maxime aspernatur, ea porro? Quaerat cupiditate aperiam
            consequatur! Delectus, soluta. Dignissimos natus eaque odio rem
            voluptas, modi maiores quisquam maxime ex et pariatur velit
            voluptatum, fuga soluta vero rerum quia asperiores id quis qui.
            Asperiores harum tempore accusantium! Sunt iure labore corporis
