      ...
      <div className="bg-white rounded-2xl p-4 md:p-6 w-full max-w-xl max-h-[90vh] md:max-h-[80vh] flex flex-col justify-between ">
        ...
        <div className="flex flex-col gap-4 items-center justify-center flex-1">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-gray-500 text-sm md:text-md">Account User</span>
          </div>
        </div>

        <div className="bg-[#C9F7FF] rounded-2xl flex flex-col justify-center items-center gap-3 md:gap-4 p-4 md:p-6 mt-4">
          <div className="flex flex-col items-center gap-1 justify-center">
            <span className="text-sm md:text-md font-semibold">Email Address</span>
            <span className="text-gray-500 text-xs md:text-md">smithjohn@mail.com</span>
          </div>
          <div className="flex flex-col items-center gap-1 justify-center">
            <span className="text-sm md:text-md font-semibold">Phone Number</span>
            <span className="text-gray-500 text-xs md:text-md">+1 234 567 890</span>
          </div>
          <div className="flex flex-col items-center gap-1 justify-center">
            <span className="text-sm md:text-md font-semibold">Location</span>
            <span className="text-gray-500 text-xs md:text-md">New York, USA</span>
          </div>
